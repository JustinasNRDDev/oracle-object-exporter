...
Sitas aplankas skirtas gyvam `UNIVERSAL_EXPORTER_IMPROVED` testavimui su lokaliu Oracle 19c konteineriu.
...
- `run_live_export.ps1` - paleidzia gyva eksporta su `--env LOCAL19`.
